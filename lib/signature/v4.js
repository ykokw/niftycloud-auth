...
class V4 extends Client{
  ...
  sendRequest(req){
    ...
    req.headers["Authorization"] = `NIFTY4-HMAC-SHA256 Credential=${this.accessKey}/${signatureObject.canonicalScope} SignedHeaders=${Utils.createSignedHeaderString(req.headers)} Signature=${signature}`;
